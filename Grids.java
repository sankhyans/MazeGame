...
public class Grids {
      ...
      public synchronized void printMaze(MazeGame gameState, int player_id,String player_name)
      {
        try
        {
          mazeSize=gameState.getMazeSize();
        for (int i = 0; i < mazeSize; i++)
        {
          ...
          System.out.println("execptn by grids");
           exp.printStackTrace();
                System.exit(0);
       }
       catch (Exception exp)
       {
           System.out.println("eby grids");
           exp.printStackTrace();
                System.exit(0);
       }
    }
